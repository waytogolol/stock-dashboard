...
非長期黑名單</b>;已上板交集頁⚠旗標(2026-07-29裁示,觀察層live驗證中)。
<b>⚠「等20天再買」已驗證無效(tmp_c3_wait20.py,使用者追問)</b>:T+20→T+60段接刀組絕對僅+0.23%/50%、
相對-0.11pp CI[-2.54,+2.08]含0——差距60日消失是因為<b>全池反彈肉集中在前20天</b>(等待=錯過肉段非撿便宜,
「肉在前段」機制家族);旗標正確用法=<b>同日多檔候選時優先選沒掛旗標的(選股)</b>,不是「掛旗標的等等再買(擇時)」</td></tr>
</table>
