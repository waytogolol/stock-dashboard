...
CATALOG = [
    ...
    ("2026-07-20", "research_attention.html", "注意股票跌觸發買訊(報告頁2026-07-26補建)", "watch",
     "晉級候選未上板:跌觸發注意公告次日開盤買T+10收+5.79%/67%(n=475,LOTO 8年全正+bootstrap雙過,差值CI[+3.66,+11.63]);"
     "混合觸發更肥+7.99%/款4唯一負排除;與甜蜜格重疊僅3.7-5%=獨立訊號;機制=官方認證式非資訊性賣壓出清,與處置V4同家族不同批=分散來源;"
     "天真買注意股-2.07%/42%=只有跌觸發子組有肉;「1-2週持有」武器庫現成缺口,上板待裁示"),
