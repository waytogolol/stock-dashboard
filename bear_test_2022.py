...
<h1>凍結規則 2022–2026 壓力測試與型態探勘（研究總結）</h1>
<div class="note">策略=規則①~④觸發買入題材前3大台股成員等權、固定持有8週、來回成本0.5%。資料=回補估算值(現任成分股+24檔降溫股補充)。
本報告回答「大方向與風險量級」，非精確績效預測。基準=台股加權指數買進持有。</div>

<h2>📋 執行摘要（研究判決表）</h2>
<table>
<tr><th>結論</th><th>證據</th><th>狀態</th></tr>
<tr><th>核心規則①~④有真實選股力</th><td>risk-on期勝率54-80%；2023 AI提早2-3個月觸發；2025記憶體+8週+123%</td><td>✅ 已驗證</td></tr>
<tr><th>熊市自動空手不成立</th><td>2022訊號密度0.61/週與牛市相當、勝率27%——成交金額型熱度會被賣壓觸發</td><td>❌ 已知弱點</td></tr>
<tr><th>階梯倉位(月線下6成/季線下3成)</th><td>3.98x/夏普1.56/MDD-27.5%，風險調整後全面勝過大盤(1.44)</td><td>✅ 已驗證</td></tr>
<tr><th>均線出場(破月線半倉/破季線清倉)</th><td>賺賠比6.7/MDD-18.7%最強防禦；但不回補致總報酬2.0x——缺回補紀律</td><td>✅ 防禦用</td></tr>
<tr><th>型態確認：突破跳空(大題材)</th><td>15.22x/夏普2.33/56筆勝率70%/2022+20%全年份為正；樣本內唯一3/3年一致</td><td>✅ 已驗證</td></tr>
<tr><th>型態確認：90日新高≥2/3</th><td>12.57x/Calmar4.86/22筆77%/持倉48%(熊市自動休眠)</td><td>✅ 已驗證</td></tr>
<tr><th>位階&lt;70當進場濾網(舊規則⑤)</th><td>黃金區組合2.60x&lt;全部4.10x；2025記憶體大魚在位階96；航運2022低位階全接刀</td><td>❌ 判決否決→降為倉位參考</td></tr>
<tr><th>相關性型共振(成員走勢整齊)</th><td>樣本內勝率45%/逐年0/3——共振有效形式是「同在突破結構」非「長得整齊」</td><td>❌ 否決</td></tr>
<tr><th>均線多頭排列/相對強度/追高(形狀1)</th><td>47%/53%/49%——追已經漲順的沒有優勢</td><td>❌ 否決</td></tr>
<tr><th>形狀0「升後回檔」(演算法發現)</th><td>樣本內20筆75%/+8.1%；微題材方向一致(3筆67%)</td><td>⏳ 待保留集驗證</td></tr>
<tr><th>A2 60日新高≥2/3</th><td>樣本內17筆71%；微題材也有效(8筆62%)——唯一跨類型皆有效</td><td>⏳ 待保留集驗證</td></tr>
<tr><th>形狀3「陰跌盤整」=迴避</th><td>樣本內20%勝率/微題材25%——死題材迴光返照</td><td>⏳ 待保留集驗證(迴避訊號)</td></tr>
<tr><th>型態藥效因訊號類型而異</th><td>突破跳空對大題材3/3年有效、對微題材失靈(50%)——微題材觸發時本來就在脈衝</td><td>✅ 分層設計原則</td></tr>
</table>
<div class="note">閱讀順序建議：本表→策略指標總表→權益曲線→型態探勘章節(頁尾)→逐筆明細對盤感。保留集(2025-26)驗證未執行，入圍名單待批准後一次定案。</div>
<h2>績效指標總表</h2>
